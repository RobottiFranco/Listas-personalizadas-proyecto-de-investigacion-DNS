...
def extraer_datos_actualizados(since: str, until: str, asn: str) -> None:
    for pais in diccionario_Paise_lista_ooni_historica:
        consulta = Consulta(base_url, "web_connectivity", pais, since, until, diccionario_Paise_lista_ooni_historica[pais], asn, None, None, None)
...
#extraer_datos_actualizados("2024-12-08", "2025-06-28", "AS16814")
