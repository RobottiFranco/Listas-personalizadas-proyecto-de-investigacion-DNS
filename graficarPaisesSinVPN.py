...
def graficar_OONI_explorer(mejorada: bool = False):
    for pais in diccionario_Paise_lista_ooni_historica:
        ...
        if mejorada:
            obtener_grafico_mejorado(consulta, "month", "category_code", None, "Graficos/mejorados/ooni_explorer", f"{pais} OONI Explorer (todo tipo de bloqueos)")
        else:
            obtener_grafico(consulta, "month", "category_code", None, "Graficos/nativos/ooni_explorer", f"{pais} OONI Explorer (todo tipo de bloqueos)")
...
def graficar_lista_historica(mejorada: bool = False):
    for pais in diccionario_Pais_lista_ooni_actualizada:
        ...
        if mejorada:
            obtener_grafico_mejorado(consulta, "month", "category_code", None, "Graficos/mejorados/historico", f"{pais} historica sin VPN (todo tipo de bloqueos)")
        else:
            obtener_grafico(consulta, "month", "category_code", None, "Graficos/nativos/historico", f"{pais} historica sin VPN (todo tipo de bloqueos)")
...
def graficar_lista_actualizada(mejorada: bool = False):
    for pais in diccionario_Pais_lista_ooni_actualizada:
        ...
        if mejorada:
            obtener_grafico_mejorado(consulta, "month", "category_code", None, "Graficos/mejorados/actualizado", f"{pais} actualizada sin VPN (solo DNS)")
        else:
            obtener_grafico(consulta, "month", "category_code", None, "Graficos/nativos/actualizado", f"{pais} actualizada sin VPN (solo DNS)")
